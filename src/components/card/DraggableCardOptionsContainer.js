...
const categorizedOptions = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'github_gitlab', name: 'GitHub / GitLab', inputType: 'text', placeholder: 'Enter profile URL(s)' },
      { id: 'dribbble_behance', name: 'Dribbble / Behance', inputType: 'text', placeholder: 'Enter profile URL(s)' },
      { id: 'youtube_channel', name: 'YouTube Channel', inputType: 'text', placeholder: 'Enter channel URL' },
      ...
      { id: 'stackoverflow', name: 'Stack Overflow Profile', inputType: 'text', placeholder: 'Enter profile URL' },
    ]
  },
  {
