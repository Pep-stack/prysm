...
export default function LinkedInProfileEditor({ value = '', onChange, onSave, onCancel }) {
  ...
  const constructLinkedInUrl = (username) => {
    if (!username) return '';
    const cleanUsername = username.trim();
    return cleanUsername ? `https://www.linkedin.com/in/${cleanUsername}/` : '';
  };

  const handleSave = () => {
    const cleanUsername = username.trim();
    const fullUrl = constructLinkedInUrl(cleanUsername);
    
    console.log('💾 LINKEDIN-PROFILE-EDITOR: Saving data:', {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-6 pb-4" style={{ backgroundColor: '#000000' }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Add your LinkedIn username</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 pt-4">
        <div className="mb-6">
          <label className="block text-white font-medium mb-2 text-sm">LinkedIn Username</label>
          ...
          <p className="text-gray-400 text-xs mt-2">Enter your LinkedIn username (from linkedin.com/in/username)</p>
        </div>
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-400 text-xs">LinkedIn User</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            style={{
              background: username.trim() 
                ? 'linear-gradient(45deg, #0077B5 0%, #00A0DC 100%)'
                : '#333',
              color: '#ffffff'
            }}
          >
